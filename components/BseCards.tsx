...
const BseCards: React.FC<BseCardsProps> = ({ 
  ...
  const gridClasses = useMemo(() => {
    if (isSidebarCollapsed) {
      return "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 pt-4 animate-in fade-in duration-700";
    }
    return "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 pt-4 animate-in fade-in duration-700";
  }, [isSidebarCollapsed]);
