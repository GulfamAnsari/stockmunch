          ...
          <div className="bg-[#161b27] border border-white/5 rounded-[2.5rem] p-8 md:p-10 shadow-2xl relative overflow-hidden flex flex-col md:flex-row items-center gap-8 group hover:border-emerald-500/20 transition-all">
            ...
            <div className="flex-grow text-center md:text-left">
               <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
                  ...
                  <div className={`px-2 py-0.5 rounded text-[8px] font-black uppercase ${isActuallyUsed ? 'bg-slate-800 text-slate-500 border border-white/5' : 'bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 animate-pulse'}`}>
