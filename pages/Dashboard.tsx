...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    document.title = "Terminal Dashboard | StockMunch Private Trading Hub";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute("content", "Access your StockMunch terminal. Real-time NSE/BSE news, personal watchlist tracking, and AI sentiment dashboard.");
    }
    fetchCoreData();
    fetchSettingsData();
