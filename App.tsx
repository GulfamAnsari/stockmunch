          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-5xl font-black text-white mb-4 uppercase tracking-tighter">
                Institutional <span className="text-[#1fa84f]">Intelligence</span>
              </h2>
              <p className="text-slate-400 text-xl font-medium max-w-2xl mx-auto opacity-80">Empowering retail traders with high-velocity data feeds.</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { title: "Instant Alerts", desc: "Native notifications delivered instantly via Telegram and Push protocols.", icon: "⚡" },
                { title: "Live Dashboard", desc: "Professional terminal for tracking NSE/BSE announcements in real-time.", icon: "🖥️" },
                { title: "AI Analysis", desc: "Proprietary sentiment engine analyzing every critical filing.", icon: "🧠" },
                { title: "Market Openers", desc: "Pre-market briefings to set your strategy before the bell rings.", icon: "🔔" },
                { title: "Secure Data", desc: "Direct exchange API integrations ensuring 100% data authenticity.", icon: "🔒" },
                { title: "Historical Feed", desc: "Searchable database of corporate actions dating back 2 years.", icon: "📂" }
              ].map((f, i) => (
                <div key={i} className="bg-[#161b27] p-10 rounded-[2rem] border border-white/5 hover:border-[#1fa84f]/20 transition-all duration-300 group shadow-2xl">
                  <div className="w-14 h-14 bg-[#1fa84f]/10 text-[#1fa84f] rounded-2xl flex items-center justify-center mb-8 border border-[#1fa84f]/10 group-hover:scale-110 transition-transform text-2xl">
                    {f.icon}
                  </div>
