    ...
    <div class="login-page">
        ...
        <div class="login-card">
            ...
            <form id="login-form" class="space-y-4">
                ...
                <button type="button" id="google-login-btn" class="btn btn-google btn-full">
                ...
                <div class="text-center">
                    <p class="text-slate-400 text-sm">Don't have an account? <a href="/signup?plan=alerts-dashboard" class="text-emerald-600 hover:text-emerald-500 font-semibold">Sign Up</a></p>
                </div>
            </form>
