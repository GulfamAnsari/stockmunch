    ...
    <div class="hero">
        ...
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="/signup?plan=alerts-dashboard" class="btn btn-primary btn-lg">
                    Sign Up Free
        ...
        <div class="container text-center">
            ...
            <div class="pricing-grid">
                ...
                <div class="pricing-card <?php echo isset($plan['popular']) && $plan['popular'] ? 'popular' : ''; ?>">
                    ...
                    <a href="/signup?plan=<?php echo $plan['id']; ?>" class="btn <?php echo isset($plan['popular']) && $plan['popular'] ? 'btn-primary' : 'btn-dark'; ?>">
                        <?php echo $plan['cta']; ?>
                    </a>
                </div>
                <?php endforeach; ?>
