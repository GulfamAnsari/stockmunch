        ...
        <div class="footer-container">
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    ...
                    <div class="social-links">
                        <a href="https://www.instagram.com/stock_munch" target="_blank" class="social-btn" title="Instagram">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="/#dashboard">Terminal Demo</a></li>
                        <li><a href="/#pricing">Subscription Plans</a></li>
                        <li><a href="/#alerts">Alert Dispatch</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-status">
                    ...
                    <div class="status-love">Made with ❤️ for Indian Traders</div>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script type="text/javascript">
      ...
      })(window, document, "clarity", "script", "v6dtqxf6it");
    </script>
</body>
</html>
